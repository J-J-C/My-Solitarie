 ...
 *
 * A Suit Stack Manager manages those finishing suit stack At this point index -> suit is fixed.
 *
 * Additional feature would be added to make it flexible between empty stack and unused suit
 *
 * @author Jiajun Chen
 */
